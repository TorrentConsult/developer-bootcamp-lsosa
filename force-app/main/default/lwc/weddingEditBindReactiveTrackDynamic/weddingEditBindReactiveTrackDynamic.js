...
export default class WeddingEditBindReactiveTrackDynamic extends LightningElement {
    ...
    handleChange(event) {
        ...
        this.wedding[event.target.name] = event.target.value;
        console.log(JSON.stringify(this.wedding));
    }
